...
<div id="login">
    ...
    <form name="loginForm" id="loginForm"  method="post">
        ...
        <p class="forgetmenot"><label for="rememberme"><input name="remeberme" type="checkbox" id="rememberme" value="1" checked /> 记住密码</label></p>
        <p class="submit">
    ...
    <p id="backtoblog"><a href="/">返回到首页</a></p>
